...
contract NewAPIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestRiskScore(string memory _smartContractAddress) public returns (bytes32 requestId) {
        ...
        string memory url = string(abi.encodePacked("http://3.108.126.225:8080/api/scanonchain?chain_category=1&smart_contract_address=", _smartContractAddress, "&network_id=11"));
