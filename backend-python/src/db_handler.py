...
class DBHandler:
    ...
    def get_findings_from_db(self, contract_adddress_hash):
        cursor = self.database.execute('SELECT json_output FROM scan_findings WHERE contract_adddress_hash = ?', (contract_adddress_hash,))
...
if __name__ == "__main__":
    DBHandler().update_polygon_contracts_risk_score()
